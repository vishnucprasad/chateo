...
abstract class $TokenCopyWith<$Res> {
  ...
  @useResult
  $Res call({Roles? role, String? token, TokenType? type});
}
...
class _$_Token implements _Token {
  const _$_Token({required this.role, required this.token, required this.type});
  ...
  @override
  String toString() {
    return 'Token(role: $role, token: $token, type: $type)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, role, token, type);
...
abstract class _Token implements Token {
  const factory _Token(
      ...
      required final TokenType? type}) = _$_Token;
